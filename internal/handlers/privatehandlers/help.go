...
func (h *HelpHandler) HandleUpdate(b *gotgbot.Bot, ctx *ext.Context) error {
	helpText := "Доступные команды:\n\n" +
		...
		"/tool - Поиск ИИ-инструментов для разработки. Используйте команду с описанием того, что вы ищете, например: `/tool лучшая IDE`. Команда работает через GPT-4o, потому ответ может быть не быстрым.\n\n" +
